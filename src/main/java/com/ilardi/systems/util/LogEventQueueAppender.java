...
public class LogEventQueueAppender extends AbstractAppender {
  ...
  public LogEventQueueAppender(String name, Filter filter,
  ...
  Property[] properties) {
    if (name == null) {
      LOGGER.error(
          "No name provided for " + LogEventQueueAppender.class.getName());
      return null;
    }
    ...
    return new LogEventQueueAppender(name, filter, layout, ignoreExceptions,
        properties);
  }
