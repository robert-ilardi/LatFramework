...
public class StringUtils {
  ...
  public static synchronized String GenerateYearlyUniqueKey() {
    ...
    uniqueId.append(Integer.toString(now.get(Calendar.DAY_OF_YEAR), 36)
        .toUpperCase().trim());
    uniqueId.append(Integer.toString(now.get(Calendar.HOUR_OF_DAY), 36)
        .toUpperCase().trim());
    uniqueId.append(
        Integer.toString(now.get(Calendar.MINUTE), 36).toUpperCase().trim());
    uniqueId.append(
        Integer.toString(now.get(Calendar.SECOND), 36).toUpperCase().trim());
  ...
  public static java.util.Date ParseDate(String dateStr, String dateFormat)
  ...
  public static void PrintArray(PrintStream printer, String name,
      String[] arr) {
    if (arr != null) {
      printer.println(
          (new StringBuffer()).append("Array \"").append(name).append("\" has ")
              .append(arr.length).append(" elements -").toString());
      for (int i = 0; i < arr.length; i++) {
        printer.println((new StringBuffer()).append(name).append("[").append(i)
            .append("] = ").append(arr[i]).toString());
      }
    }
    else {
      printer.println((new StringBuffer()).append("Array \"").append(name)
  ...
  public static void PrintList(String name, List<?> lst) {
    ...
    if (lst != null) {
      System.out
          .println("List \"" + name + "\" has " + lst.size() + " elements -");
      iter = lst.iterator();
      while (iter.hasNext()) {
  ...
  public static void PrintMap(String name, Map<?, ?> map) {
    ...
    if (map != null) {
      ...
      System.out
          .println("Map \"" + name + "\" has " + map.size() + " elements -");
  ...
  public static boolean EqualsOne(String s, String[] arr,
   ...
   */
  public static String ApplyParameters(String text, String placeHolder,
      String placeHolderRegEx, String[] parameters) {
    ...
    while (index >= 0 && parameters != null && cnt < parameters.length) {
      parameterizedText = parameterizedText.replaceFirst(placeHolderRegEx,
          parameters[cnt++]);
      index = parameterizedText.indexOf(placeHolder);
    }
  ...
  public static String ApplyParameters(String text, String placeHolder,
    ...
    while (index >= 0 && parameters != null && cnt < parameters.length) {
      parameterizedText.replace(index, index + placeHolder.length(),
          parameters[cnt]);
      index = parameterizedText.indexOf(placeHolder,
          index + parameters[cnt].length());
      cnt++;
    }
  ...
  public static String[] Escape(String[] tokens, char escapee,
      char escapingChar) {
  ...
  public static String HumanReadableTime(long milliSeconds) {
    ...
    seconds = (int) (((inpSecs - (days * 86400)) - (hours * 3600))
        - (minutes * 60));
  ...
  public static boolean ContainsOnly(String text, String segment) {
    ...
    if (text.length() > 0 && segment.length() > 0) {
      ...
      only = (index == 0);
      while (only && index != -1
          && (index + segment.length()) < text.length()) {
        lastIndex = index;
  ...
  public static String HtmlCharacterEncoderIgnoreNewLines(String text) {
    ...
    if (text != null) {
      for (int i = 0; i < text.length(); i++) {
        ...
        if ((ascii < 48 || ascii > 57) && (ascii < 65 || ascii > 90)
            && (ascii < 97 || ascii > 122) && ascii != 32 && ascii != 13
            && ascii != 10) {
          html.append("&#");
  ...
  public static String[] FixedLengthSplit(String str, int[] lens) {
    ...
    if (str != null && (sLen = str.length()) > 0 && lens != null
        && lens.length > 0) {
  ...
  public static String PrepareFixedLengthRecord(String[] tokens,
      char[] fieldPaddings, boolean[] padLeftDirections, int[] fieldLens,
      boolean appendNewLine) {
    StringBuffer record = new StringBuffer();

    if (tokens != null && fieldPaddings != null && fieldPaddings.length != 0
        && fieldLens != null && fieldPaddings.length == fieldLens.length
        && padLeftDirections != null
        && fieldPaddings.length == padLeftDirections.length) {
      for (int i = 0; i < fieldLens.length; i++) {
        if (padLeftDirections[i]) {
          // Pad Left
          record.append(LPad((i < tokens.length ? tokens[i] : ""),
              fieldPaddings[i], fieldLens[i]));
        }
        else {
          // Pad Right
          record.append(RPad((i < tokens.length ? tokens[i] : ""),
              fieldPaddings[i], fieldLens[i]));
        }
      } // End for i loop
  ...
  public static String[] ReadLinesIgnoreComments(InputStream ins,
  ...
  public static String GetNextWordNegativeDelimiter(String stmt, int startPos,
      char[] delimiters) {
    StringBuffer sb = new StringBuffer();
    char ch;
    int i;
  ...
  public static int GetPositionAfterNextWordNegativeDelimiter(String stmt,
      int startPos, char[] delimiters) {
    StringBuffer sb = new StringBuffer();
    char ch;
    int i;
  ...
  public static String GetNextWordRespectSingleQuotes(String stmt, int startPos,
      char escapeChar) {
    StringBuffer sb = new StringBuffer();
    char ch;
    int i;
  ...
  public static int GetPositionAfterNextWordRespectSingleQuotes(String stmt,
  ...
  public static boolean EndsWithOne(String s, String[] suffix,
      boolean ignoreCase) {
    boolean ends = false;
  ...
  public static String CombineWithDelimiter(String[] tokens, String delimiter,
      int len, boolean startingDelimiter, boolean trailingDelimiter) {
    StringBuffer sb = new StringBuffer();
  ...
  public static void PrintArray(PrintStream printer, String name, byte[] arr) {
    if (arr != null) {
      ...
      for (int i = 0; i < arr.length; i++) {
        printer.println((new StringBuffer()).append(name).append("[").append(i)
            .append("] = ").append(SystemUtils.GetAsciiFromByte(arr[i]))
            .toString());
      }
    }
    else {
  ...
  public static Properties GetPrefixedPropNames(Properties props,
      String prefix) {
    Properties prefixedProps = null;
    Iterator<Object> iter;
    String name, value;
  ...
  public static String[] Append(String[] record1, String[] record2) {
    ...
    if (record1 != null && record1.length > 0 && record2 != null
        && record2.length > 0) {
  ...
  public static void PrintArray(String name, Object[] arr) {
    ...
    if (arr != null) {
      System.out
          .println("Array \"" + name + "\" has " + arr.length + " elements -");
      for (int i = 0; i < arr.length; i++) {
  ...
  public static String replaceStr(String origStr, String newToken,
      String oldToken) {
    String retStr = "";
    for (int i = 0, j = 0; (j = origStr.indexOf(oldToken, i)) > -1; i = j
        + oldToken.length()) {
      retStr += (origStr.substring(i, j) + newToken);
    }
    return (origStr.indexOf(oldToken) == -1) ? origStr
        : retStr + origStr.substring(
            origStr.lastIndexOf(oldToken) + oldToken.length(),
            origStr.length());
  }
  ...
  public static int parseIntDef(String s, int d) {
    ...
    if (s == null)
      ...
      try {
        ...
        System.out.println("ENAFUtils.parseIntDef: Integer.parseInt(" + s
            + ") conversion failed!!!  Using default [" + d + "].");
        // e.printStackTrace();
        x = d;
      }
    }
  ...
  public static Integer valueOfDef(String s, Integer d) {
    ...
    if (s.trim().length() == 0) {
      ...
      try {
        ...
        System.out.println(
            "Exception: Integer.valueOf(" + s + ") conversion failed!!!");
        e.printStackTrace();
        x = d;
      }
    }
  ...
  public static Double doubleOfDef(String s, java.lang.Double dd) {
    ...
    if (s.trim().length() == 0) {
      ...
      try {
        ...
        System.out.println(
            "Exception: Double.valueOf(" + s + ") conversion failed!!!");
        e.printStackTrace();
        x = dd;
      }
    }
  ...
  public static String SimpleHTMLCharEncoderWithNewLineReplacement(
      String text) {
    StringBuffer html = new StringBuffer();
    char c;
  ...
  public static int GetNextArrayIndex(String[] arr, String val,
      int startIndex) {
    int index = -1;

    if (arr != null && val != null && startIndex >= 0
    ...
    if (arr1 != null && arr2 != null && arr1.length == arr2.length) {
      ...
      for (int i = 0; i < arr1.length; i++) {
        if ((arr1 == null && arr2 != null)
            || (arr1 != null && !arr1[i].equals(arr2[i]))) {
          same = false;
        }
      }
    }
  ...
  public static String EnsureFilenameChars(String origName,
  ...
  public static String ConvertEscapedUnicode(String escapedStr)
  ...
  public static String MD5Hashing(String original)
  ...
  public static Properties GetPropertiesUsingPropNamePrefix(Properties props,
      String prefix) {
    Properties prefixedProps = null;
    Iterator<Object> iter;
    String name, value;
  ...
  public static Properties RemovePrefixFromPropNames(Properties props,
      String prefix) {
  ...
  public static List<String> GetValueListUsingPropNamePrefix(Properties props,
      String prefix) {
