...
public final class LatConstants {

  //Web Server Properties----------------------------------------------------->

  public static final String LAT_WEB_SERVER_PORT = "com.ilardi.systems.lat.web.serverPort";
  public static final String LAT_WEB_SERVER_NAME = "com.ilardi.systems.lat.web.serverName";

  public static final String LAT_REST_SERVICES_CLASSNAME_LIST = "com.ilardi.systems.lat.web.restServicesClassnameList";

  public static final String LAT_WEB_SERVER_CONTEXT_PATH = "com.ilardi.systems.lat.web.contextPath";
  public static final String LAT_WEB_SERVER_PATH_SPEC = "com.ilardi.systems.lat.web.pathSpec";

  //-------------------------------------------------------------------------->

  //LAT Services Pool Properties---------------------------------------------->  

  public static final String LAT_SERVICE_POOL_SERVICE_LIST = "com.ilardi.systems.lat.mediator.servicePool.serviceList";

  public static final String LAT_SERVICE_POOL_SERVICE_PROPS_PREFIX = "com.ilardi.systems.lat.mediator.servicePool.services";

  public static final String LAT_SERVICE_POOL_SERVICE_CLASSNAME_PROPS_SUFFIX = "className";
  public static final String LAT_SERVICE_POOL_SERVICE_TYPE_ENUM_PROPS_SUFFIX = "LatServiceTypeEnum";
  public static final String LAT_SERVICE_POOL_SERVICE_LOAD_INDEX_PROPS_SUFFIX = "poolLoadIndex";
  public static final String LAT_SERVICE_POOL_SERVICE_MIN_INSTANCES_PROPS_SUFFIX = "minPoolInstances";
  public static final String LAT_SERVICE_POOL_SERVICE_MAX_INSTANCES_PROPS_SUFFIX = "maxPoolInstances";
