...
public class ChatService {
  ...
  private synchronized HttpPost getHttpPost(String jsonStr)
  ...
  public synchronized LatAiChatResponse send(LatAiChatRequest oaReq,
      ChatKey chatKey) throws LatException {
    ...
    String jsonStr = null;
    int httpStatusCode;
    LatAiChatValueObjectType reqType;
    ...
    try {
      ...
      if (httpEntity != null) {
        ...
        switch (httpStatusCode) {
          case HttpStatus.SC_OK:
            oaRes = objMapper.readValue(jsonStr,
                LatAiChatSuccessResponse.class);
            break;
          default:
            oaRes = objMapper.readValue(jsonStr, LatAiChatErrorResponse.class);
        }
      ...
      throw new LatException(
          "An error occurred while attempting to send OpenAI Chat Request. System Message: "
              + e.getMessage(),
          e);
    }
    finally {
